...
const PROCESSORS = [
  "AMD(R) Ryzen(R) 3 2200G CPU at 3.5GHz",
  "Intel(R) Core(tm) i5-10400 CPU at 3.3GHz",
  "Intel(R) Core(tm) i3-12100T CPU at 2.3GHz",
  "AMD(R) Ryzen(R) 5 3600 CPU at 3.6GHz",
  "AMD(R) Ryzen(R) 7 5800X CPU at 3.8GHz",
  "Intel(R) Core(tm) i7-10700 CPU at 3.1GHz"
];
...
const keySound = new Audio("https://windowsfan2021.github.io/bios/assets/key.mp3");
...
const sound = new Audio("https://windowsfan2021.github.io/bios/assets/boot.mp3");
...
class AwardBoot extends HTMLElement {
  ...
  turnOn() {
    const cpu = PROCESSORS[~~(Math.random() * PROCESSORS.length)];
    return this.setHTML(".header", `
      <img class="epa" src="https://windowsfan2021.github.io/bios/assets/epa.png" alt="Energy EPA">
      <div class="brand-text">
        <img class="ribbon" src="https://windowsfan2021.github.io/bios/assets/award-logo.png" alt="Award Logo">
          <p>
            Award Modular BIOS v4.50G, An Energy Star Ally<br>
              Copyright (C) 1984-94, Award Software, Inc.
          </p>
        </div>
          <p>LaytonTV ACPI BIOS Revision 2763</p>
          <p>
            ${cpu}<br>
  ...
  render() {
    ...
    <div class="screen">
      ...
      <p class="last off">
        ...
        ${date()}-i440LX-<strong>WF2021_GHIO</strong>-00
      </p>
    </div>`;
  }
}
...
class AwardBios extends HTMLElement {
  ...
  exitBIOS() {
    ...
    screen.innerHTML = `<p>C:\\&gt;<span class="typewriter" data-duration="2000" data-delay="0">ltvpersonal.exe</span><span class="cursor"></span>`;
    typewriter(screen.querySelector(".typewriter"));
    setTimeout(() => {
      screen.innerHTML = `
        <p>
          C:\\&gt;ltvpersonal.exe<br><br>
          Starting <strong>windowsfan2021.github.io</strong>...<span class="cursor"></span>
        </p>
      `;
    }, 3000);
  }
